...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "-1"  # This will make TensorFlow use CPU only
import tensorflow as tf
tf.config.set_visible_devices([], 'GPU')  # For TensorFlow 2.x
...
if image_based:
    ...
    env = football_env.create_environment(env_name='7v7', representation='simple115')
...
while not target_reached and iters < max_iters:
    ...
    for itr in range(ppo_steps):
        state_input = K.expand_dims(state, 0)  # Assuming 'left_team_active' is part of the state
